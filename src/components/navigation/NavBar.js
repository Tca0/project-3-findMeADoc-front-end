...
function NavBar({storageToken,updateStorageToken}){
  ...
  <LinkContainer to="/">
  <Navbar.Brand>findMeADoc <FontAwesomeIcon icon={faHospitalUser} /></Navbar.Brand>
  </LinkContainer>
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <LinkContainer to="/users/login">
      <Nav.Link> Log in <FontAwesomeIcon icon={faIdCard}/></Nav.Link>
    </LinkContainer>

    <LinkContainer to="/users/register">
      <Nav.Link> Register <FontAwesomeIcon icon={faUserPlus}/></Nav.Link>
    </LinkContainer>
    </>
    }
    </Nav>
